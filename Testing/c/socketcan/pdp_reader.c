...
void parseFrame2(struct can_frame frame){
	float currentScalar = 0.125f;
	int i1=frame.data[0];
	i1=i1<<2;
	i1=i1|(frame.data[1]>>6 & 0x03);
	...
	float voltage = .05*frame.data[6]+4;
 	printw(" %2.2fV",voltage);

        float temperature = 1.03250836957542 * frame.data[7] - 67.8564500484966; 
 	printw(" %2.2fC",temperature);
}
